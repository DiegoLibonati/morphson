...
import type { AnchorActionProps } from "@/types/props";
...
const AnchorAction = ({
  ...
  return (
    <Link
      ...
      className={`group relative w-64 p-2 bg-secondary text-light-grey text-center text-xl rounded-lg transition-all hover:text-white hover:font-semibold ${className}`}
    >
      {children}
      {!noMark && (
