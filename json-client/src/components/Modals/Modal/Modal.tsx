import { ModalProps } from "@src/entities/props";

export const Modal = ({ children }: ModalProps): JSX.Element => {
  return (
    <div className="flex items-center justify-center absolute top-0 left-0 z-10 h-screen w-full bg-black bg-opacity-45 modal-root">
